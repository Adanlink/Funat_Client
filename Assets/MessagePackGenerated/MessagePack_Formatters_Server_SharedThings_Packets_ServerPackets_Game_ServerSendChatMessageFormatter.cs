...
namespace MessagePack.Formatters.Server.SharedThings.Packets.ServerPackets.Game
{
    ...
    public sealed class ServerSendChatMessageFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.ServerPackets.Game.ServerSendChatMessage>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.ServerPackets.Game.ServerSendChatMessage value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
