...
namespace MessagePack.Formatters.Server.SharedThings.Packets.Representations
{
    ...
    public sealed class OwnPlayerFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.Representations.OwnPlayer>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.Representations.OwnPlayer value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
