...
namespace MessagePack.Formatters.Server.SharedThings.Packets.ServerPackets
{
    ...
    public sealed class LoginSucceededFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.ServerPackets.LoginSucceeded>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.ServerPackets.LoginSucceeded value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
