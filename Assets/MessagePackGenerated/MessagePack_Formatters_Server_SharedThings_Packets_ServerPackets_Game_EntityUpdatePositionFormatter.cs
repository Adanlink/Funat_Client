...
namespace MessagePack.Formatters.Server.SharedThings.Packets.ServerPackets.Game
{
    ...
    public sealed class EntityUpdatePositionFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.ServerPackets.Game.EntityUpdatePosition>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.ServerPackets.Game.EntityUpdatePosition value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
