...
namespace MessagePack.Formatters.Server.SharedThings.Packets.Representations
{
    ...
    public sealed class PlayerFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.Representations.Player>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.Representations.Player value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
