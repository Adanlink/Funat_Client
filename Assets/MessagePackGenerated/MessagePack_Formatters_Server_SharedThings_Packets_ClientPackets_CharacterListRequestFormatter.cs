...
namespace MessagePack.Formatters.Server.SharedThings.Packets.ClientPackets
{
    ...
    public sealed class CharacterListRequestFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.ClientPackets.CharacterListRequest>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.ClientPackets.CharacterListRequest value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
