...
namespace MessagePack.Formatters.Server.SharedThings.Packets.Representations
{
    ...
    public sealed class CharacterFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Server.SharedThings.Packets.Representations.Character>
    {


        public void Serialize(ref MessagePackWriter writer, global::Server.SharedThings.Packets.Representations.Character value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            formatterResolver.GetFormatterWithVerify<global::Server.SharedThings.Enums.AuthorityType>().Serialize(ref writer, value.Authority, options);
            formatterResolver.GetFormatterWithVerify<global::System.DateTime>().Serialize(ref writer, value.TimeOfCreation, options);
            formatterResolver.GetFormatterWithVerify<global::System.DateTime>().Serialize(ref writer, value.LastTimePlayed, options);
